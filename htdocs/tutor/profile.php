...
// Fetch current info
$query = "SELECT name, email, profile_pic FROM tutors WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['size'] > 0) {
        ...
        $file_name = $tutor_id . "_" . basename($_FILES['profile_pic']['name']);
    ...
    // Update query
    $update_sql = "UPDATE tutors SET name='$new_name', email='$new_email' $password_sql $profile_pic_sql WHERE id=$tutor_id";
